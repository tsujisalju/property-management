...
export default async function FinanceDashboard() {
    ...
    try {
        ...
        fetchError = err instanceof Error ? err.message : "Unknown error fetching finance data.";
    }
    ...
    return (
        <main className="min-h-screen bg-base-200 p-6 space-y-8">

            {/* ── Page title ────────────────────────────────────────────────────── */}
            <div>
                <h1 className="text-2xl font-bold flex items-center gap-2">
                    <BadgeDollarSign className="text-primary" size={28} />
                    Finance Dashboard
                </h1>
                <p className="text-base-content/60 text-sm mt-1">
                    {now.toLocaleString("en-MY", { month: "long", year: "numeric" })} overview
                </p>
            </div>
            ...
            <div className="card bg-base-100 shadow">
                <div className="card-body">
                    <h2 className="card-title text-lg mb-4">Budget Overview — {
                                ...
                                return (
                                    <div key={cat}>
                                        ...
                                        <div className="flex justify-between text-sm mb-1">
                                            ...
                                            <span className={isOver ? "text-error font-semibold" : "text-base-content/70"}>
